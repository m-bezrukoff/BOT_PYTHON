from simulator_v3.playground_data import Data
from simulator_v3.playground_multiprocessor import MultiProcessorRender
from simulator_v3.playground_summary import Summary
from simulator_v3.playground_plotly import Graphics
...
class Worker:
    ...
    def format_graphics_data(self):
        ...
        self.graphics_data['frame'] = self.params['frame']
...
if __name__ == '__main__':
    ...
    params = {
        ...
        'strategy_margin': 3,      # запас по свечам слева для правильной отработки стратегии на первой свече
    ...
    r = Summary(w)
    w.format_graphics_data()
    print('total time spent:', to2(time() - t10), 'sec')
    print('--------------------------------------------\r\n')
    graphics = Graphics(w.graphics_data)
